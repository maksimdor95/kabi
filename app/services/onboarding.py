...
STEPS: list[Step] = [
    ...
    Step(
        "priorities",
        "Что сейчас важнее искать в первую очередь?\n\n"
        "• Работа — вакансии по роли (/today)\n"
        "• Выступления — СМИ/подкасты (/pitch) и CFP (/talks)\n"
        "• Оба — и вакансии, и выступления (вакансии чуть раньше)\n\n"
        "Выбери кнопку ниже.",
        buttons=("Работа", "Выступления", "Оба"),
        hint="Выбери: Работа (вакансии), Выступления (питч/CFP) или Оба.",
    ),
    Step(
        "salary",
